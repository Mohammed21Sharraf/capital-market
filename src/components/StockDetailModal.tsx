...
export function StockDetailModal({ stock, isOpen, onClose }: StockDetailModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="border-border bg-card sm:max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {/* Trading Analytics */}
          <div>
            <h3 className="text-sm font-semibold mb-3 uppercase tracking-wider text-muted-foreground">Trading Activity</h3>
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Fundamentals</h3>
              {loadingFundamentals && <Loader2 className="h-4 w-4 animate-spin text-muted-foreground" />}
            </div>
            ...
            {loadingFundamentals ? (
              ...
              <p className="text-sm text-muted-foreground text-center py-4">Fundamental data unavailable</p>
            )}
          </div>
        </div>
      </DialogContent>
...
function FundamentalCard({
  ...
  return (
    <div className="rounded-lg bg-muted/50 p-3">
      <p className="text-xs text-muted-foreground">{label}</p>
      <p className={cn("font-mono text-sm font-semibold text-foreground mt-1 truncate", valueClass)}>
        {value}
      </p>
    </div>
  );
